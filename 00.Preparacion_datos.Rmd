...
children <- read_sav("./data/raw/endes back up/2020/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2019/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2018/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2017/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2016/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2015/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2014/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2013/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
nacion <- read_sav("./data/raw/endes back up/2012/RECH1.sav") %>% unite("CASEID", HHID:HVIDX, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2012/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
nacion <- read_sav("./data/raw/endes back up/2011/RECH1.sav") %>% unite("CASEID", HHID:HVIDX, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2011/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2010/RECH6.sav") %>%  unite("CASEID", HHID:HC0, sep = "  ",remove = FALSE) #HHID
