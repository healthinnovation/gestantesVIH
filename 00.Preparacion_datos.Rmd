...
children <- read_sav("./data/raw/endes back up/2021/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
table(df_gestantes2021$S411H, exclude = NULL) 
...
children <- read_sav("./data/raw/endes back up/2020/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2019/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2018/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2017/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2016/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2015/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
# Gestantes
...
children <- read_sav("./data/raw/endes back up/2014/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2013/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2012/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2011/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
...
children <- read_sav("./data/raw/endes back up/2010/REC21.SAV") %>%  group_by(CASEID) %>% filter(BORD == max(BORD))
