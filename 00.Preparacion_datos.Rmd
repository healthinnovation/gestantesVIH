...
children <- read_sav("./data/raw/endes back up/2012/RECH6.sav") %>%  unite("CASEID", HHID,HC51, sep = "  ",remove = FALSE) #HHID
...
children <- read_sav("./data/raw/endes back up/2011/RECH6.sav") %>%  unite("CASEID", HHID,HC51, sep = "  ",remove = FALSE) #HHID
