...
```{r}
###############
df_gestantes2$WEALTH_INDEX <- factor(df_gestantes2 $ WEALTH_INDEX, levels =  c("POOREST", "POOR", "MIDDLE" ,"RICH", "RICHEST"))

df_gestantes2$EDU_LEVEL <- factor(df_gestantes2 $ EDU_LEVEL, levels =  c("NONE/PRESCHOOL", "PRIMARY", "SECONDARY" ,"HIGHER"))
...
ggsave("test_wealth.png",dpi = 300, width = 8, height = 6)
...
ggsave("test_edu.png",dpi = 300, width = 10, height = 8)
...
#Prueba plot grid
plot_grid (hiv, map_hiv, hiv_wi,hiv_edu,labels = c("a","b","c","d"))

ggsave("join_plot.png", dpi = 300, bg = "white", width = 12, height = 10)
```
