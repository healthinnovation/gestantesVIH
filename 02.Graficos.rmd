...
df_gestantes<- read.csv("./data/datatest.csv") %>% 
  ...
  mutate(
    EDU_LEVEL = ifelse(EDU_LEVEL == "PRIMARY","NONE/PRESCHOOL/PRIMARY",
                       ifelse(EDU_LEVEL == "NONE/PRESCHOOL","NONE/PRESCHOOL/PRIMARY",EDU_LEVEL))
  )
...
ggsave("grafico3.png",width = 13,height = 10, dpi = 300)
